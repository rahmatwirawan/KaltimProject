...
<?php
	$aksi="modul/modul_izinLokasi/control_data_izinLokasi.php";
	$idTemp=4;
switch($_GET[act]){
  // Tampil Relawan
  default:
...
<script src="assets/plugins/jQuery-lib/2.0.3/jquery.min.js"></script>
		...
		<link rel="stylesheet" href="assets/plugins/DataTables/media/css/DT_bootstrap.css" />
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Izin Lokasi <small>overview &amp; stats </small></h1>
							</div>
						</div>	
						...
						<div class="col-sm-12">
							...
							<div class="panel panel-default">
								...
								?>
									...
									<div class="col-sm-9">
									<form action="<?php echo $aksi?>?module=izinLokasi&act=editImage" method="POST"  enctype="multipart/form-data">
					...
					<div class="row fileupload-buttonbar">
						<div class="col-lg-7">
							<button onclick="window.location.href='?module=izinLokasi&act=tambahizinLokasi'" class="btn btn-primary start">
								<i class="glyphicon glyphicon-upload"></i>
								<span>Tambah Izin Lokasi</span>
							</button>
						</div>
					</div>
										...
										<table class="table table-striped table-hover" id="sample_2">
											...
											?>
												<tr>
													...
													<td><a href="?module=izinLokasi&act=editizinLokasi&<?php echo 'id='.$id; ?>"> Edit </a></td>
													<td><a href="<?php echo $aksi.'?module=izinLokasi&act=delete&id='.$id; ?>"> Delete </a></td>
												</tr>
												<?php
													$no++;
													}
 ...
 <script src="editor/js/libs/jquery-1.11.1.min.js"></script><script src="editor/js/froala_editor.min.js"></script><script src="editor/js/plugins/tables.min.js"></script><script src="editor/js/plugins/lists.min.js"></script><script src="editor/js/plugins/colors.min.js"></script><script src="editor/js/plugins/media_manager.min.js"></script><script src="editor/js/plugins/font_family.min.js"></script><script src="editor/js/plugins/font_size.min.js"></script><script src="editor/js/plugins/block_styles.min.js"></script><script src="editor/js/plugins/video.min.js"></script><script>$(function(){$('#edit').editable({inlineMode: false})});</script><link href="editor/css/font-awesome.min.css" rel="stylesheet" type="text/css"><link href="editor/css/froala_editor.min.css" rel="stylesheet" type="text/css"><link href="editor/css/froala_style.min.css" rel="stylesheet" type="text/css">
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Tambah Izin Lokasi <small>overview &amp; stats </small></h1>
							</div>
						</div>	
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
								<form action="<?php echo $aksi."?module=izinLokasi&act=input" ?>" method="POST">
									<div class="row">
										<div class="col-sm-12">
		 ...
		 <script src="editor/js/libs/jquery-1.11.1.min.js"></script><script src="editor/js/froala_editor.min.js"></script><script src="editor/js/plugins/tables.min.js"></script><script src="editor/js/plugins/lists.min.js"></script><script src="editor/js/plugins/colors.min.js"></script><script src="editor/js/plugins/media_manager.min.js"></script><script src="editor/js/plugins/font_family.min.js"></script><script src="editor/js/plugins/font_size.min.js"></script><script src="editor/js/plugins/block_styles.min.js"></script><script src="editor/js/plugins/video.min.js"></script><script>$(function(){$('#edit').editable({inlineMode: false})});</script><link href="editor/css/font-awesome.min.css" rel="stylesheet" type="text/css"><link href="editor/css/froala_editor.min.css" rel="stylesheet" type="text/css"><link href="editor/css/froala_style.min.css" rel="stylesheet" type="text/css">
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Edit Izin Lokasi <small>overview &amp; stats </small></h1>
							</div>
						</div>	
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
								<form action="<?php echo $aksi."?module=izinLokasi&act=edit" ?>" method="POST">
									<div class="row">
										<div class="col-sm-12">
										<?php
											$id=$_GET['id'];

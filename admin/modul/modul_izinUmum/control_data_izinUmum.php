...
session_start();
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
  echo "<a href=../index.php><b>LOGIN</b></a></center>";
	...
	// Input relawan
	if ($module=='izinUmum' AND $act=='input'){
	...
	}elseif ($module=='izinUmum' AND $act=='edit'){
		$isi=$_POST['penjelasan'];
		$judul=$_POST['judul'];
		$idEdit=$_POST['idEdit'];
	...
	}elseif ($module=='izinUmum' AND $act=='editImage'){
		$judul=$_POST['judul'];
		...
		if(($_FILES['avatar']['name'])==""){
		  ...
		  $queryImageMenu=mysql_query("select * from imageMenu where id='9'");
	...
	}elseif ($module=='izinUmum' AND $act=='delete'){
		  $id = $_GET['id'];

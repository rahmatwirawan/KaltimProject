...
<?php
	$aksi="modul/modul_izinUmum/control_data_izinUmum.php";
	$idTemp=9;
switch($_GET[act]){
  // Tampil Relawan
  default:
...
<script src="assets/plugins/jQuery-lib/2.0.3/jquery.min.js"></script>
		...
		<link rel="stylesheet" href="assets/plugins/DataTables/media/css/DT_bootstrap.css" />
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<ol class="breadcrumb">
								...
								<li class="active">
									Perizinan Secara Umum
								</li>
							</ol>
							<div class="page-header">
								<h1>Perizinan Secara Umum <small>overview &amp; stats </small></h1>
							</div>
						</div>	
						...
						<div class="col-sm-12">
							...
							<div class="panel panel-default">
								...
								?>
									...
									<div class="col-sm-9">
									<form action="<?php echo $aksi?>?module=izinUmum&act=editImage" method="POST"  enctype="multipart/form-data">
					...
					<div class="row fileupload-buttonbar">
						<div class="col-lg-7">
							<button onclick="window.location.href='?module=izinUmum&act=tambahizinUmum'" class="btn btn-primary start">
								<i class="glyphicon glyphicon-upload"></i>
								<span>Tambah Perizinan Secara Umum</span>
							</button>
						</div>
					</div>
										...
										<table class="table table-striped table-hover" id="sample_2">
											...
											?>
												<tr>
													...
													<td><a href="?module=izinUmum&act=editizinUmum&<?php echo 'id='.$id; ?>"> Edit </a></td>
													<td><a href="<?php echo $aksi.'?module=izinUmum&act=delete&id='.$id; ?>"> Delete </a></td>
												</tr>
												<?php
													$no++;
													}
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<ol class="breadcrumb">
								...
								<li class="active">
									Tambah Perizinan Secara Umum
								</li>
							</ol>
							<div class="page-header">
								<h1>Tambah Perizinan Secara Umum <small>overview &amp; stats </small></h1>
							</div>
						</div>	
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
								<form action="<?php echo $aksi."?module=izinUmum&act=input" ?>" method="POST">
									<div class="row">
										<div class="col-sm-12">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<ol class="breadcrumb">
								...
								<li class="active">
									Edit Perizinan Secara Umum
								</li>
							</ol>
							<div class="page-header">
								<h1>Edit Perizinan Secara Umum <small>overview &amp; stats </small></h1>
							</div>
						</div>	
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
								<form action="<?php echo $aksi."?module=izinUmum&act=edit" ?>" method="POST">
									<div class="row">
										<div class="col-sm-12">
										<?php
											$id=$_GET['id'];

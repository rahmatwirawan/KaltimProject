...
session_start();
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
  echo "<a href=../index.php><b>LOGIN</b></a></center>";
	...
	if ($module=='ippt' AND $act=='input'){
	...
	}elseif ($module=='ippt' AND $act=='edit'){
		$isi=$_POST['penjelasan'];
		$judul=$_POST['judul'];
		$idEdit=$_POST['idEdit'];
	...
	}elseif ($module=='ippt' AND $act=='editImage'){
		$judul=$_POST['judul'];
		...
		if(($_FILES['avatar']['name'])==""){
		  ...
		  $queryImageMenu=mysql_query("select * from imageMenu where id='5'");
	...
	}elseif ($module=='ippt' AND $act=='delete'){
		  $id = $_GET['id'];
